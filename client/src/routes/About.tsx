...
const About: React.FC = () => {
  return (
    <div className="overflow-hidden bg-navy-900 py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-4xl">
          <p className="text-base/7 font-semibold text-gold">About Me</p>
          ...
          <h2 className="py-5 text-2xl font-semibold tracking-tight text-pretty text-white">
            Who Am I
          </h2>
        </div>
        <p className="mt-6 text-base/7 text-slate-400">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            ...
            {/* <p className="mt-8 text-base/7 text-slate-400">
          ...
          <div className="max-lg:mt-16 lg:col-span-1">
            <p className="text-base/7 font-semibold text-slate-400">Education</p>
            ...
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-white/10 pb-4">
                <dt className="text-sm/6 text-slate-400">United States Navy </dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-white">
                  <span>Veteran</span>
                </dd>
              </div>
              <div className="flex flex-col gap-y-2 border-b border-dotted border-white/10 pb-4">
                <dt className="text-sm/6 text-slate-400">
              ...
              <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-white/10 max-sm:pb-4">
                <dt className="text-sm/6 text-slate-400">Eastern University</dt>
                <dd className="order-first text-6xl font-semibold tracking-tight text-white">
